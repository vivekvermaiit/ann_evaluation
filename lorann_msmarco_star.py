...
# Paths
# -----------------------------
BASE_DIR = Path.home() / "scratch/knn_datasets/dense_datasets/msmarco-star"
DATA_PATH = BASE_DIR / "dataset.npy"
QUERY_PATH = BASE_DIR / "queries.npy"
GT_PATH = BASE_DIR / "groundtruth.npy"
OUT_PATH = "lorann_msmarco_star_results_4096.tsv"
...
N_CLUSTERS = 4096 # can try 2048 as well
GLOBAL_DIM = 128          # low dimensional data
QUANT_BITS = 8
DISTANCE = lorann.IP

# LoRANN query hyperparameters
POINTS_TO_RERANK = 3200    # fixed, not swept
...
INDEX_PATH = str(INDEX_DIR / "msmarco_star_lorann_4096.idx")
...
print(f"  Index time to build MS Marco Star: {index_time:.2f} s")
# -----------------------------
# Run sweep
# -----------------------------
results_rows = []
