...
# Paths
# -----------------------------
BASE_DIR = Path.home() / "scratch/knn_datasets/dense_datasets/gist"
DATA_PATH = BASE_DIR / "dataset.npy"
QUERY_PATH = BASE_DIR / "queries.npy"
GT_PATH = BASE_DIR / "groundtruth.npy"
OUT_PATH = "lorann_replication_effort_results/lorann_gist_results_2048.tsv"
...
N_CLUSTERS = 2048 # can try 2048 as well
...
INDEX_PATH = str(INDEX_DIR / "gist_lorann_2048.idx")
...
print(f"  Index time to build GIST: {index_time:.2f} s")
# -----------------------------
# Run sweep
# -----------------------------
results_rows = []
