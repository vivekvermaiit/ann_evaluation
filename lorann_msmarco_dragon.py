...
# Paths
# -----------------------------
BASE_DIR = Path.home() / "scratch/knn_datasets/dense_datasets/msmarco-dragon"
DATA_PATH = BASE_DIR / "dataset.npy"
QUERY_PATH = BASE_DIR / "queries.npy"
GT_PATH = BASE_DIR / "groundtruth.npy"
OUT_PATH = "lorann_msmarco_dragon_results_4096.tsv"
...
INDEX_PATH = str(INDEX_DIR / "msmarco_dragon_lorann_4096.idx")
...
print(f"  Index time to build MS Marco Dragon: {index_time:.2f} s")
# -----------------------------
# Run sweep
# -----------------------------
results_rows = []
